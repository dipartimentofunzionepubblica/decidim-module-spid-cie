  ...
  module Cie
    class OmniauthCallbacksController < ::Decidim::Devise::OmniauthRegistrationsController
      ...
      def cie
        ...
        if user_signed_in?
          ...
          flash[:notice] = t(
            ...
            scope: "decidim.cie.verification"
          )
          return redirect_to(
      ...
      def create
        ...
        origin = Base64.strict_decode64(session[:"#{Decidim::Cie::Utils.session_prefix}sso_params"]["relay_state"]) rescue ''
          ...
          on(:ok) do |user|
            ...
            if user.active_for_authentication?
              if existing_identity
                ...
                i = user.identities.find_by(uid: session["#{Decidim::Cie::Utils.session_prefix}uid"]) rescue nil
